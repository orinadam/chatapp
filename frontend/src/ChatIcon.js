...
const ChatIcon = (props) => {
  const setSelectedChat = useSetRecoilState(selectedChat);
    ...
    return (
        <Box border='1px solid #BDBDBD' cursor="pointer" _hover={{background: "#E0E0E0",color: "teal", }} padding={1} h={50} w={300} borderColor="gray.300" borderRadius={2} onClick={handleClick}>
